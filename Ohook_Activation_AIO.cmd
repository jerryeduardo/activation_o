...
set "blank="
set "mas=ht%blank%tps%blank%://%blank%/"
...
echo:
echo:
echo Help - %mas%troubleshoot.hml
echo:
echo:
ping 127.0.0.1 -n 10
)
...
set _el=!errorlevel!
if !_el!==4  exit /b
if !_el!==3  start %mas%genuine-installation-media.hml &goto :oh_menu
...
echo:
echo %mas%genuine-installation-media.hml
goto dk_done
)
...
::  mas/office-license-is-not-genuine.hml
...
call :dk_color %Blue% "You can download it from %mas%genuine-installation-media.hml"
)
...
::
::  For any further question, feel free to contact us on mas/contactus
::
::========================================================================================================================================
